...
func (r *RawClient) Create(
...
) (*core.Response[*myorganization.CreateClientGrantResponseContent], error) {
	...
	var response *myorganization.CreateClientGrantResponseContent
	...
	return &core.Response[*myorganization.CreateClientGrantResponseContent]{
