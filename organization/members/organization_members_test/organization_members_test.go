...
package organization_members_test
...
func TestOrganizationMembersListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Organization.Members.List(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestOrganizationMembersListWithWireMock"}},
		),
	)
...
func TestOrganizationMembersGetWithWireMock(
	...
	_, invocationErr := client.Organization.Members.Get(
		context.TODO(),
		"user_id",
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestOrganizationMembersGetWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestOrganizationMembersGetWithWireMock", "GET", "/members/user_id", map[string]string{"fields": "fields", "include_fields": "true"}, 1)
}
