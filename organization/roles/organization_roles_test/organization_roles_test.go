...
package organization_roles_test
...
func TestOrganizationRolesListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Organization.Roles.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestOrganizationRolesListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestOrganizationRolesListWithWireMock", "GET", "/roles", map[string]string{"from": "from", "take": "1", "name": "name"}, 1)
}
