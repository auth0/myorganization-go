...
package organization_user_stores_test
...
func TestOrganizationUserStoresListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Organization.UserStores.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestOrganizationUserStoresListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestOrganizationUserStoresListWithWireMock", "GET", "/user-stores", map[string]string{"member_access_level": "none", "is_enabled": "true"}, 1)
}
